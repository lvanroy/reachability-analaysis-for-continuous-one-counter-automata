...
A mathematical proof for the the theoretical algorithm on which this approach is based is given in the paper by Michael Blondin et al. \cite{blondin2021continuous}. This paper will proof that this algorithm will always terminate, and will do so in at most $(4\vert Q\vert ² + 5\vert Q\vert)$ accelerations.
