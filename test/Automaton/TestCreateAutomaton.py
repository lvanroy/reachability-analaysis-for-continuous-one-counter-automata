...
class TestCreateAutomaton(unittest.TestCase):
    ...
    def test_graph_edges(self):
        ...
        self.assertEqual("+0", str(automaton.get_edge_operation("q1", "q2")))
        self.assertEqual("+20", str(automaton.get_edge_operation("q2", "q3")))
        self.assertEqual("+1", str(automaton.get_edge_operation("q3", "q1")))
        self.assertEqual("+0", str(automaton.get_edge_operation("q1", "q4")))
        self.assertEqual("-20", str(automaton.get_edge_operation("q4", "q5")))
        self.assertEqual("+1", str(automaton.get_edge_operation("q5", "q1")))

        self.assertEqual("<=15", str(automaton.get_node_condition("q2")))
        self.assertEqual(">=20", str(automaton.get_node_condition("q3")))
        self.assertEqual(">=20", str(automaton.get_node_condition("q4")))
        self.assertEqual("<=10", str(automaton.get_node_condition("q5")))
    ...
    def test_edge_with_conditional_label(self):
        ...
        self.assertFalse(automaton.edge_exists("q1", "q2"))
        self.assertFalse(automaton.edge_exists("q2", "q3"))
        self.assertTrue(automaton.edge_exists("q1", "_0"))
        self.assertTrue(automaton.edge_exists("_0", "q2"))
        self.assertTrue(automaton.edge_exists("q2", "_1"))
        self.assertTrue(automaton.edge_exists("_1", "q3"))
        self.assertTrue(automaton.edge_exists("q3", "q1"))
        self.assertTrue(automaton.edge_exists("q1", "q4"))
        self.assertTrue(automaton.edge_exists("q4", "q5"))
        self.assertTrue(automaton.edge_exists("q5", "q1"))
        ...
        self.assertEqual("<=10", str(automaton.get_node_condition("_0")))
        self.assertEqual(">=20", str(automaton.get_node_condition("_1")))
        self.assertEqual("<=15", str(automaton.get_node_condition("q2")))
        self.assertEqual(">=20", str(automaton.get_node_condition("q3")))
        self.assertEqual(">=20", str(automaton.get_node_condition("q4")))
        self.assertEqual("<=10", str(automaton.get_node_condition("q5")))
    ...
    def test_node_with_operational_label(self):
        ...
        self.assertTrue(automaton.edge_exists("q0", "q1"))
        self.assertTrue(automaton.edge_exists("q1", "q2"))
        self.assertTrue(automaton.edge_exists("q2", "_0"))
        self.assertTrue(automaton.edge_exists("_0", "q3"))
        self.assertTrue(automaton.edge_exists("q3", "_1"))
        self.assertTrue(automaton.edge_exists("_1", "q1"))
        self.assertTrue(automaton.edge_exists("q1", "q4"))
        self.assertTrue(automaton.edge_exists("q4", "q5"))
        self.assertTrue(automaton.edge_exists("q5", "q1"))

        self.assertEqual("+15", str(automaton.get_edge_operation("q2", "_0")))
        self.assertEqual("-20", str(automaton.get_edge_operation("q3", "_1")))
        self.assertEqual("+0", str(automaton.get_edge_operation("q1", "q2")))
        self.assertEqual("+20", str(automaton.get_edge_operation("_0", "q3")))
        self.assertEqual("+1", str(automaton.get_edge_operation("_1", "q1")))
        self.assertEqual("+0", str(automaton.get_edge_operation("q1", "q4")))
        self.assertEqual("-20", str(automaton.get_edge_operation("q4", "q5")))
        self.assertEqual("+1", str(automaton.get_edge_operation("q5", "q1")))
